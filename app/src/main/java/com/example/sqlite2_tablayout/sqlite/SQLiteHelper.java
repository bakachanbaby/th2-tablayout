...
public class SQLiteHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "CongViecDB2.db";
    ...
    public void onCreate(SQLiteDatabase db) {
        String sql = "CREATE TABLE congviec(" +
                ...
                "ten TEXT,noidung TEXT,ngay TEXT,tinhtrang TEXT,congtac TEXT, loai TEXT)";
        db.execSQL(sql);
    }
    ...
    public List<CongViec> getAll() {
        ...
        while (rs != null && rs.moveToNext()) {
            ...
            list.add(new CongViec(id, ten, noidung, ngay, tinhtrang, congtac, loai));//lay duoc tat ca cac ban ghi
        }
        return list;
    }
