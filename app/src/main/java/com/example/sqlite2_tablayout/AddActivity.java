    ...
    public void onClick(View view) {
        ...
        if (view==btAdd){
            ...
            if(rb1.isChecked())
                ...
                congtac="False";
            String doituong = "";
            if(cb1.isChecked()) doituong += "Học, ";
            if(cb2.isChecked()) doituong += "Chơi, ";
            if(cb3.isChecked()) doituong += "Làm, ";
            doituong = doituong.trim();
            doituong = doituong.substring(0, doituong.length() - 1);
            if(!ten.isEmpty() && !noidung.isEmpty()){
                CongViec congViec=new CongViec(ten,noidung,ngay,tinhtrang,congtac, doituong);
